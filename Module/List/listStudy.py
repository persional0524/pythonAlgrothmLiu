...
print(str[:-4:-1])  # 逆序截取，步长为3                     　　　　　　　　　　  #96
print(str[:-4:-3])  # 逆序截取，步长为3                     　　　　　　　　　　  #96
print(str[10:0:-1])  # 逆序截取，起始值为列表的第11为数，到列表第1位数之前的数结束，　　#987654321
print(str[10:0:-2])  # 逆序截取，起始值为列表的第11为数，到列表第1位数之前的数结束，　　#987654321
print(str[9:0:-3])  # 逆序截取，起始值为列表的第11为数，到列表第1位数之前的数结束，　　#987654321
